        ...
        <div class="lg:w-2/4 mx-auto py-8 px-6 bg-white rounded-xl">
            ...
            <div class="mb-6">
                <form action="/" class="flex flex-col space-y-4" method="POST">
                    @csrf
                    <input type="text" name="title" placeholder="The Todo Title" class="py-4 px-4 bg-gray-100 rounded-xl" id="">
                    
                    <textarea name="description" placeholder="The Todo Description" class="py-4 px-4 bg-gray-100 rounded-xl" >
